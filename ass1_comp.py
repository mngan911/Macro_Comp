...
"""With lag = 1, RMSE is lower in case h=1 (0.32 vs 0.34) and higher in case h=4 and h=8. The model predicts better than the case lag=4 in shorter term only. We show it graphically."""
